  ...
  return (
    <div className="pt-24 pb-16 bg-gray-50 min-h-screen">
      <div className="container mx-auto px-8 lg:px-16">
        ...
        >
          <h1 className="text-4xl sm:text-5xl font-bold text-center mb-8 sm:mb-12 text-gray-900 font-merriweather">Our Team</h1>
          
          {/* Team Heads Section */}
          <div className="mb-16 sm:mb-20 text-center mx-auto max-w-6xl">
            <h2 className="text-2xl sm:text-3xl font-semibold text-center mb-8 sm:mb-12 text-gray-800 font-merriweather">Leadership</h2>
              ...
              {teamMembers.filter(member => member.isHead).map((member, index) => (
                ...
                >
                  ...
                  <div className="p-6 sm:p-8 text-center">
                    <h3 className="text-xl sm:text-2xl font-semibold text-gray-900 mb-3">{member.name}</h3>
                    <p className="text-[#4CC3D9] font-medium mb-4 text-lg">{member.role}</p>
                    <p className="text-gray-600 text-base sm:text-lg">{member.description}</p>
                  </div>
                </div>
              ))}
            </div>
          ...
          <div className="text-center mx-auto max-w-7xl">
            <h2 className="text-2xl sm:text-3xl font-semibold text-center mb-8 sm:mb-12 text-gray-800 font-merriweather">Team Members</h2>
              ...
              {teamMembers.filter(member => !member.isHead).map((member, index) => (
                ...
                >
                  ...
                  <div className="p-4 sm:p-6 text-center">
                    ...
                    <p className="text-[#4CC3D9] text-base font-medium mb-2 sm:mb-3">{member.role}</p>
